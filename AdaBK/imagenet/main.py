...
def main_worker(gpu, ngpus_per_node, args):
    ...
    if args.alg=='wsgd':
       optimizer = WSGDM(model,lr=args.lr,momentum=0.9,weight_decay=args.weight_decay)
    if args.alg=='wadam':
       optimizer = WAdam(model,lr=args.lr,weight_decay=args.weight_decay) 
    if args.alg=='sgdmbk':
       optimizer = SGDM_BK(model,lr=args.lr,momentum=0.9,weight_decay=args.weight_decay)
    if args.alg=='adamwbk':
       optimizer = AdamW_BK(model,lr=args.lr,weight_decay=args.weight_decay) 
